...
path = r"../pickle_files/final_project_dataset.pkl"
...
## i have considered the original features and picked the top 10 values
...
new_feature_list = ['poi'] + list(best_features.keys())
clf = make_data_test(DecisionTreeClassifier(criterion="entropy",splitter="best"), my_dataset, features_list, 10)
...
clf4 = make_data_test(RandomForestClassifier(max_depth =5 , max_features = 'sqrt', n_estimators = 10, random_state = 42),
                 my_dataset ,new_feature_list, 10)




from sklearn.cluster import KMeans
clf3 = make_data_test(KMeans(n_clusters=2, tol=0.1,random_state=42, max_iter=1000),my_dataset ,new_feature_list, 10)




# Best results made by
clf = make_data_test(GaussianNB(),my_dataset ,new_feature_list, 10)


pickle.dump(clf, open("my_classifier.pkl", "wb") )
pickle.dump(enron_data, open("enron_data.pkl", "wb") )
